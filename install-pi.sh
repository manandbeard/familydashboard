...
PROJECT_DIR="/home/$(whoami)/familydashboard"
...
if [ -z "$GITHUB_REPO" ]; then
    GITHUB_REPO="manandbeard/familydashboard"
...
sudo chown -R $(whoami):$(whoami) "${PROJECT_DIR}/family-photos"
sudo chmod 755 "${PROJECT_DIR}/family-photos"
...
echo "   🌐 Web access: http://0.0.0.0:5000"
...
echo "3. Test the dashboard: curl http://0.0.0.0:5000"
