...
if [ -d "/home/nhell/familydashboard/family-photos" ]; then
    PHOTO_COUNT=$(ls -1 /home/nhell/familydashboard/family-photos | wc -l)
...
if [ -f "/home/nhell/.config/autostart/familydashboard.desktop" ]; then
